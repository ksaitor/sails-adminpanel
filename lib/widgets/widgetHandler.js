...
const abstractSwitch_1 = __importDefault(require("./abstractSwitch"));
const abstractInfo_1 = __importDefault(require("./abstractInfo"));
const abstractAction_1 = __importDefault(require("./abstractAction"));
const abstractLink_1 = __importDefault(require("./abstractLink"));
const accessRightsHelper_1 = require("../../helper/accessRightsHelper");
const abstractCustom_1 = __importDefault(require("./abstractCustom"));
;
class WidgetHandler {
    static add(widget) {
