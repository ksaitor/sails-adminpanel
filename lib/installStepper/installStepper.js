...
const finalizeStep_1 = __importDefault(require("./finalizeStep"));
const fs = __importStar(require("fs"));
const translationHelper_1 = require("../../helper/translationHelper");
class InstallStepper {
    constructor(id, canBeClosed = false) {
        this.steps = [];
        this.context = {};
        this.id = id;
        this.canBeClosed = canBeClosed;
    }
    static addStepper(stepper) {
    ...
    static getStepper(stepperId) {
        return this.instances.find(item => item.id === stepperId);
    }
    static deleteStepper(stepperId) {
